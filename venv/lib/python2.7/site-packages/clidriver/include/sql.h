...
#define SQL_DBPARTITION_NUM_TO_NAME(name_p,dbpartition_num) \
        0 <= dbpartition_num ? sprintf(name_p,"DBPARTITION%.*d", SQL_PDB_DBPARTITION_NUM_DIGIT, dbpartition_num) : \
                             sprintf(name_p,"DBPARTITION%.*d", SQL_PDB_DBPARTITION_NUM_DIGIT-1, dbpartition_num)
/* Codepages                                                                  */
